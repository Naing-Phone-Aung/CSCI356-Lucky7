...
namespace StarterAssets
{
    public class Combat : MonoBehaviour
    {
        ...
        public int max1Int = 10;
        public int min1Int = 15;
        ...
        private void DealDamage()
        {
            ...
            int damage = _weaponManager.equippedWeapon != null ? _weaponManager.equippedWeapon.damage : 5; // Default punch damage
            ...
            foreach (Collider enemyCollider in hitEnemies)
            {
                ...
                GolemEnemy Genemy = enemyCollider.GetComponent<GolemEnemy>();
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            {
                currentHealth -= Random.Range(max1Int, min1Int);
            }
        }
    }
}